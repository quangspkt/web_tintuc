...
class pagination{
	private $_totalItem;// tong so item
	public $_nItemOnPage; // so luong item trong 1 page
	private $_nPageShow ; // so luong link page hi?n th?
	private $_totalPage; // tong so page
	private $_currentPage; // page hien thi
