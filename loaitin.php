<?php
    ...
    $tintucs =$controller_tintuc->loaitin();
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <form class="navbar-form navbar-left" role="search">
                    ...
                    <button type="button" id="btnSearch" class="btn btn-default">tim kiem</button>
                </form>
    ...
    <div class="container">
        <div class="row">
           <div class="col-md-3 ">
            ...
            <div class="col-md-9 " id="dataseach">
                <div class="panel panel-default">
                    ...
                    <?php
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="chitiet.php?loai_tin=<?=$alias?>&id_tin=<?=$tin->id?>">
                                <br>
                        ...
                        <div class="col-md-9">
                            <h3><?=$tin->TieuDe?></h3>
                            <p><?=$tin->TomTat?></p>
                            <a class="btn btn-primary" href="chitiet.php?loai_tin=<?=$alias?>&id_tin=<?=$tin->id?>">View Project <span class="glyphicon glyphicon-chevron-right"></span></a>
                        </div>
                        <div class="break"></div>
                    </div>
                           <?php
